...
import com.example.mybus3_4_2020.Customer.CustomerLoginActivity;
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            startActivity(new Intent(DriverLoginActivity.this, AnotherMainActivity.class));
                           finish();
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(DriverLoginActivity.this, ""+user.getEmail(), Toast.LENGTH_SHORT).show();


                            //go to profile activity after logged in
                           startActivity(new Intent(DriverLoginActivity.this, AnotherMainActivity.class));
                           // HomeActivity2 = new Intent(DriverLoginActivity.this , AnotherMainActivity.class);
                            //finish();
                            //updateUI(user);
                        } else {
                            // If sign in fails, display a message to the user.
